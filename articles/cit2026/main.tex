...
% AI use declaration (policy requirement).
\input{sections/05-ai-declaration}

% ---- Ukrainian bibliography (DSTU 8302:2015) — required by journal.
\citrefheading{\foreignlanguage{ukrainian}{Список бібліографічного опису}}
\input{bib/bibliography-uk}

% ---- English references list — same order, unsrt keeps numbering aligned.
